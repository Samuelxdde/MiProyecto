...
public class ReservaDAO {
    ...
    public boolean insertarReserva(Reserva Mireserva) {
        ...
        String sql = "INSERT INTO Reserva (idReserva, num_personas, hora, fecha, Usuarios_idUsuarios, Disponibilidad_idDisponibilidad, Estado_reserva_idEstado_reserva, Actividad_idActividad, Pagos_idPagos) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            ps.setDate(4,Mireserva.getFecha());
