...
public class PruebaUsuario {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.print("Ingrese el ID de Actividad:");
        usuarios.setActividad_idActividad(sc.nextInt());
        ...
        for (Usuarios u : lista) {
            System.out.println("ID: " + u.getidUsuarios() + " Nombre: " + u.getnombre() + " " + u.getapellido());
        }
        ...
        System.out.print("Nuevo ID Actividad: ");
        usuMod.setActividad_idActividad(sc.nextInt());
