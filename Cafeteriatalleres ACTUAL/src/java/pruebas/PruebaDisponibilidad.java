...
public class PruebaDisponibilidad {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.println("\nListado de cupos disponibles:");
        for (Disponibilidad d : dao.consultarDisponibilidad()) {
            System.out.println("ID: " + d.getidDisponibilidad() + "Fecha: " + d.getfecha() + "Disponibles: " + d.getcupo_disponible());
        }
